    ...
    <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="overflow-x-auto">
        <div className="min-w-[860px]">
          <div className="grid grid-cols-[1.4fr_1fr_0.9fr_1fr_1.2fr] items-center gap-2 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white px-4 py-3 text-xs font-semibold uppercase tracking-wide text-slate-600">
            <span>Project</span>
            <span>Status</span>
            <span>Priority</span>
            <span>Assigned</span>
